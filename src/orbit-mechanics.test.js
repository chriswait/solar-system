...
describe("can get elements at date", function () {
  it("earth at J2000", function () {
    ...
    let newElements = OrbitMechanics.getElementsAtCenturiesPastJ2000(
      keplerianElements,
      0
    );
    ...
    expect(newElements.semiMajorAxisAu).toBe(
      keplerianElements.initial.semiMajorAxisAu
    );
    expect(newElements.eccentricityRadians).toBe(
      keplerianElements.initial.eccentricityRadians
    );
    expect(newElements.inclinationDegrees).toBe(
      keplerianElements.initial.inclinationDegrees
    );
    expect(newElements.meanLongitudeDegrees).toBe(
      keplerianElements.initial.meanLongitudeDegrees
    );
    expect(newElements.periapsisLongitudeDegrees).toBe(
      keplerianElements.initial.periapsisLongitudeDegrees
    );
    expect(newElements.ascendingNodeLongitudeDegrees).toBe(
      keplerianElements.initial.ascendingNodeLongitudeDegrees
    );
    // computed parameters
  ...
  it("earth at J2100", function () {
    ...
    expect(newElements.semiMajorAxisAu).toBe(
      keplerianElements.initial.semiMajorAxisAu +
        keplerianElements.rates.semiMajorAxisAu
    );
    expect(newElements.eccentricityRadians).toBe(
      keplerianElements.initial.eccentricityRadians +
        keplerianElements.rates.eccentricityRadians
    );
    expect(newElements.inclinationDegrees).toBe(
      keplerianElements.initial.inclinationDegrees +
        keplerianElements.rates.inclinationDegrees
    );
    expect(newElements.meanLongitudeDegrees).toBe(
      keplerianElements.initial.meanLongitudeDegrees +
        keplerianElements.rates.meanLongitudeDegrees
    );
    expect(newElements.periapsisLongitudeDegrees).toBe(
      keplerianElements.initial.periapsisLongitudeDegrees +
        keplerianElements.rates.periapsisLongitudeDegrees
    );
    expect(newElements.ascendingNodeLongitudeDegrees).toBe(
      keplerianElements.initial.ascendingNodeLongitudeDegrees +
        keplerianElements.rates.ascendingNodeLongitudeDegrees
    );
    // computed parameters
