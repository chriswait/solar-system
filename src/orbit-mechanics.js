...
export class OrbitMechanics {
  ...
  static getElementsAtCenturiesPastJ2000(keplerianElements, currentCenturiesPastJ2000) {
    ...
    Object.entries(keplerianElements.initial).forEach(([elementKey, elementValue]) => {
      elements[elementKey] = elementValue + keplerianElements.rates[elementKey] * currentCenturiesPastJ2000
    })
