...
describe("should scale at default of 1", function () {
  ...
  it("0, 0, 0", function () {
    expect(screen.realToVisualised(new Vector3(0, 0, 0))).toEqual(
      new Vector3(0, 0, 0)
    );
  });
  it("1, 2, 3", function () {
    expect(screen.realToVisualised(new Vector3(1, 2, 3))).toEqual(
      new Vector3(1, 3, 2)
    );
  });
});
describe("should scale correctly with scaleFactor set", function () {
  ...
  it("1, 1, 1", function () {
    ...
    expect(screen.realToVisualised(new Vector3(1, 1, 1))).toEqual(
